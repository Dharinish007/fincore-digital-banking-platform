...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TransactionOwnershipViolationException.class)
    public ResponseEntity<Object> handleTransactionOwnershipViolation(TransactionOwnershipViolationException ex) {
    ...
    public ResponseEntity<Object> handleAccountServiceException(AccountServiceException ex) {
        ...
        return build(status, "Account service error: " + (ex.getMessage() != null ? ex.getMessage() : "status " + ex.getStatusCode()));
    }
