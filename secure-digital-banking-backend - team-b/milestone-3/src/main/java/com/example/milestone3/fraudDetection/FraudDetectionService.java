...
public class FraudDetectionService {
   ...
   if(fraudStatus.equals("BLOCKED")||fraudStatus.equals("UNDER_REVIEW")) {
       notificationService.sendEmail(new NotificationRequest("user_email", "Fraud Detected", "Your Transaction with id " + transaction.getTransactionReference() + "is under " + fraudStatus));
