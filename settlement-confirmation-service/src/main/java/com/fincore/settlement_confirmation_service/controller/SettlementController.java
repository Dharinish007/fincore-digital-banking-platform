...
public class SettlementController {
	...
	@PostMapping
	public ResponseEntity<SettlementResponseDTO> createSettlement(@RequestBody Settlement settlement) {
		SettlementResponseDTO created = settlementService.createSettlement(settlement);
