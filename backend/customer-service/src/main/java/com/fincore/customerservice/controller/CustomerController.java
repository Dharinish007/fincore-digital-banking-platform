...
import com.fincore.customerservice.dto.CustomerStatisticsResponse;
@RestController
...
public class CustomerController {
    ...
    public ResponseEntity<ApiResponse<Page<CustomerResponse>>> searchCustomers(
            ...
            @PageableDefault(size = 20, sort = "id") Pageable pageable) {
        Page<CustomerResponse> response = customerService.searchCustomersByName(name.trim(), pageable);
