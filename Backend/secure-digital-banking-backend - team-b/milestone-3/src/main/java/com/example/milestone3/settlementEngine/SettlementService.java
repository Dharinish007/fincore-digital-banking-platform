...
public class SettlementService {
    ...
    public Settlement settlePayment(Long transactionId) {
        ...
        Settlement finalSettlement = new Settlement();

        finalSettlement.setTransactionId(transaction.getId());
        finalSettlement.setLoanId(transaction.getLoanId());
        finalSettlement.setSettledAmount(transaction.getAmount());
        finalSettlement.setStatus("SETTLED");
        finalSettlement.setSettledAt(LocalDateTime.now());

        return settlementRepo.save(finalSettlement);
    }
}
