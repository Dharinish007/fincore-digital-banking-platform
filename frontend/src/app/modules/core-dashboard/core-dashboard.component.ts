      ...
      <div class="core-banking-card">
        <div class="card-header-bar">
          ...
          <div class="header-actions-group">
            <button type="button" class="btn-transfer-quick" (click)="openTransferModal()">
        ...
        <div class="banking-details-list">
          <div class="detail-line">
            ...
            <span class="d-val font-bold text-green">₹ {{ accountService.activeAccount().balance.toLocaleString('en-IN') }}</span>
          </div>
          ...
          <div class="detail-line actions-line">
            ...
            <div class="action-btn-group">
              <button type="button" class="action-link" (click)="navigateToStatements()">[View Statement]</button>
              <button type="button" class="action-link" (click)="openTransferModal()">[Transfer / Deposit]</button>
              <button 
                type="button" 
...
export class CoreDashboardComponent implements OnInit {
  ...
  openEditModal() {
    ...
    this.modalService.openEditAccountModal(this.accountService.activeAccount().id);
  }

  openTransferModal() {
    this.openTransferModalTrigger.emit();
    this.modalService.openTransferModal();
  }

  navigateToStatements() {
    this.goToStatements.emit();
    this.router.navigate(['/statements']);
  }

  navigateToBalance() {
    this.goToBalance.emit();
