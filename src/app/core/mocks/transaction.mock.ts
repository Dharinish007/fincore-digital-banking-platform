...
export const TRANSACTIONS_MOCK: Transaction[] = [
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Monthly salary credit',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Transfer to checking account',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'ATM cash withdrawal',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Vendor payment – Acme Corp',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Monthly maintenance fee',
  ...
  },
  {
    ...
    status: TransactionStatus.CANCELLED, description: 'Withdrawal request – cancelled by customer',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Savings to fixed deposit transfer',
  ...
  },
  {
    ...
    status: TransactionStatus.PENDING, description: 'Quarterly tax payment',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Utility bill payment',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'International wire transfer receipt',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Online banking transaction fee',
  ...
  },
  {
    ...
    status: TransactionStatus.PENDING, description: 'Capital transfer to fixed deposit',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Branch cash withdrawal',
  ...
  },
  {
    ...
    status: TransactionStatus.COMPLETED, description: 'Cash deposit at branch counter',
