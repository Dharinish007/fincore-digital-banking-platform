...
export const ACCOUNTS_MOCK: Account[] = [
  {
    id: 'ACC-0001', accountNumber: 'FIN-100-0001', customerId: 'CUST-0001',
  ...
  {
    id: 'ACC-0002', accountNumber: 'FIN-100-0002', customerId: 'CUST-0001',
    customerName: 'James Harrison', accountType: AccountType.CHECKING,
    branch: 'Downtown', balance: 8200.00, availableBalance: 8200.00,
    currency: 'USD', status: AccountStatus.ACTIVE,
    openedAt: '2021-04-12T09:00:00Z', updatedAt: '2024-03-15T10:30:00Z'
  },
  {
    id: 'ACC-0003', accountNumber: 'FIN-200-0001', customerId: 'CUST-0002',
  ...
  {
    id: 'ACC-0004', accountNumber: 'FIN-300-0001', customerId: 'CUST-0003',
  ...
  {
    id: 'ACC-0005', accountNumber: 'FIN-300-0002', customerId: 'CUST-0003',
    customerName: 'Robert Chen', accountType: AccountType.FIXED_DEPOSIT,
  ...
  {
    id: 'ACC-0006', accountNumber: 'FIN-400-0001', customerId: 'CUST-0004',
    customerName: 'Emily Rodriguez', accountType: AccountType.SAVINGS,
    branch: 'Eastview', balance: 1200.00, availableBalance: 1200.00,
    currency: 'USD', status: AccountStatus.DORMANT,
    openedAt: '2023-06-05T09:00:00Z', updatedAt: '2023-09-01T11:00:00Z'
  },
  {
    id: 'ACC-0007', accountNumber: 'FIN-500-0001', customerId: 'CUST-0005',
    customerName: 'Michael Thompson', accountType: AccountType.CHECKING,
    branch: 'Southpark', balance: 320.00, availableBalance: 0,
    currency: 'USD', status: AccountStatus.FROZEN,
    openedAt: '2022-11-10T09:00:00Z', updatedAt: '2024-01-25T09:30:00Z'
  },
  {
    id: 'ACC-0008', accountNumber: 'FIN-600-0001', customerId: 'CUST-0006',
  ...
  {
    id: 'ACC-0009', accountNumber: 'FIN-600-0002', customerId: 'CUST-0006',
    customerName: 'Jessica Williams', accountType: AccountType.FIXED_DEPOSIT,
  ...
  {
    id: 'ACC-0010', accountNumber: 'FIN-700-0001', customerId: 'CUST-0007',
