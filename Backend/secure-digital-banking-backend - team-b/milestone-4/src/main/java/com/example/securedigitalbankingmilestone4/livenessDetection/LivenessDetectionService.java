...
import com.example.securedigitalbankingmilestone4.client.DTO.NotificationRequest;
import com.example.securedigitalbankingmilestone4.client.NotificationClient;
...
public class LivenessDetectionService {
    ...
    public LivenessDetectionService(LivenessDetectionRepo repo, AuditRepo auditRepo, NotificationClient notificationClient) throws IOException {
    ...
    public LivenessVerification verify(Long userId, String challenge, MultipartFile video, String ipAddress) throws IOException {
        ...
        try {
            ...
            if (facePositions.size() < 2) {
                ...
                notificationClient.sendEmail(new NotificationRequest("user_email","Liveness Verification","Liveness verification attempt "+result.getAttempt()+" Failed. Please Try again"));
            ...
            saveEvent(result,ipAddress);
            notificationClient.sendEmail(new NotificationRequest("user_email","Liveness Verification","Liveness verification attempt "+result.getAttempt()+" is"+result.getStatus()));
            return repo.save(result);
